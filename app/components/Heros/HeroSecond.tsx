...
export default function SecondHero() {
  return (
    <section className="h-screen max-h-[1000px] flex items-center py-20 sm:py-24 lg:py-32 border-t border-b border-[#1E2D45]">
        ...
        <div className="flex flex-col items-center lg:flex-row lg:items-end gap-10 lg:gap-1">
          ...
          <div className="flex-1 max-w-[800px]">
            ...
            <div className="flex justify-center mb-8 lg:hidden">
              <TrendingUp size={250} className="text-[#3B82F6]" strokeWidth={1.5} />
            </div>
            ...
            <h2 className="font-display font-extrabold text-[#E2E8F0] leading-[0.92] tracking-[-1.5px] text-center lg:text-left
              ...
              Про ИТ услуги
              <br />
              <span className="text-[#3B82F6]">и тех. консалтинг</span>
            </h2>
